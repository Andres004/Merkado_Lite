...
const cartItems = [
  {
    id: 1, // Esto será id_producto en el backend
...
export default function CheckoutPage() {
  ...
  const handleConfirmarPedido = async () => {
    try {
      ...
      // 1. Determinar la dirección exacta
      let direccionFinal = "";
      ...
      // 2. Calcular la fecha (ISO String)
      // Si es inmediato, mandamos la fecha actual.
      // Si es programado y llenó los datos, construimos la fecha.
      let fechaProgramadaISO = new Date().toISOString();
      
      if (tipoTiempo === 'programado' && formData.fechaEntrega && formData.horaEntrega) {
        // Formato simple para crear fecha: "2023-12-31T09:00:00"
        // Tomamos solo la hora de inicio del rango "09:00-11:00" -> "09:00"
      ...
      // 3. CONSTRUCCIÓN DEL PAYLOAD (Adaptado al DTO de tu compañera)
      const payload = {
        // IMPORTANTE: Asegúrate que el usuario con ID 1 exista en tu BD postgres
        id_usuario_cliente: 1, 
        
        tipo_pedido: "VENTA",
        metodo_pago: "EFECTIVO", // Hardcodeado por ahora, según tu UI es pago al recibir
        
        direccion_entrega: direccionFinal,
        tipo_entrega: formData.metodoEntrega === 'delivery' ? 'DELIVERY' : 'TIENDA',
        
        fecha_hora_programada: fechaProgramadaISO,
        
        // Mapeo de items del carrito
      ...
      router.push('/confirmacion'); // Redirigir a página de éxito
      
    } catch (error: any) {
      console.error(" Error al confirmar:", error);
      
      if (error.response) {
        // Error que viene del Backend (ej. 400 o 500)
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {/* --- LÓGICA: MOSTRAR DIRECCIONES SOLO SI ES DELIVERY --- */}
          ...
          <section>
            ...
            {/* Inputs de fecha (desvanecidos si es inmediato) */}
