        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-9 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">Configuración del Panel</h1>
              ...
              <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700">Moneda mostrada</label>
                    <select
                    ...
                    <p className="text-xs text-gray-500">Se usará para mostrar importes en las vistas administrativas.</p>
                  </div>

                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700">Color principal del panel</label>
                    <select
                    ...
                    <p className="text-xs text-gray-500">Afecta solo los botones principales de esta sección.</p>
                  </div>

                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700">Mostrar clientes en Usuarios</label>
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full border transition-colors duration-200 ${
                          settings.showClients ? "bg-green-500 border-green-500" : "bg-gray-200 border-gray-200"
                        }`}
                    ...
                    <p className="text-xs text-gray-500">Controla si los clientes aparecen en la sección Usuarios.</p>
                  </div>

                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700">Filtros por defecto en Usuarios</label>
                    <select
                    ...
                    <p className="text-xs text-gray-500">Se aplicará al abrir la lista de Usuarios.</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 pt-4 border-t border-gray-100">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={handleSave}
                      className={`px-4 py-2 rounded-lg font-semibold shadow ${primaryButtonClass}`}
                    >
                      Guardar
                    </button>
                  </div>
